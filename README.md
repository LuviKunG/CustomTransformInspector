...
{
  "dependencies": {
    "com.luvikung.customtransforminspector": "https://github.com/LuviKunG/CustomTransformInspector.git#1.0.0"
  }
}
```
...
**https://github.com/LuviKunG/CustomTransformInspector.git#1.0.0**
